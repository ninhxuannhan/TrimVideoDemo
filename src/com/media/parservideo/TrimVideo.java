...
public class TrimVideo extends Activity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSrcVideoPath = "/storage/emulated/0/Download/MP4 Files.mp4";
        ...
        mVideoView.setVideoPath(mSrcVideoPath);
    ...
    private void trimVideo() {
        ...
        mDstFileInfo = android.os.Environment.getExternalStorageDirectory()
				+ "/VRP/";
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    VideoUtils.startTrim(mSrcFile, new File(mDstFileInfo+ String.valueOf(System.currentTimeMillis()) + ".mp4"),
                ...
                mHandler.post(new Runnable() {
                    ...
                    public void run() {
                        Toast.makeText(getApplicationContext(),
                            getString(R.string.save_into, mDstFileInfo),
                            Toast.LENGTH_SHORT)
                            .show();
                        ...
                        if (mProgress != null) {
                            ...
                            intent.setDataAndType(Uri.fromFile(new File(mDstFileInfo)), "video/*");
